            ...
            <div class="container" id="container1">
                ...
                <div id="main">
                    ...
                    <div id="content">
                        ...
                        <form action="<?php echo base_url() ?>BanHang/themCuaHang" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" id="diaChi" placeholder="Nhập địa chỉ" name="diaChi" value="">
                            </div>
                            <div class="form-group">
